...
public class Languages5WordsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.languages5words);
        Button boton = (Button) findViewById(R.id.bEnrere);
        boton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Languages5WordsActivity.this.finish(); // ... cerramos el activity actual
            }
        });
                    ...
                    if (idioma1.matches(idioma2)) {
                        ...
                        if (hiha) {
                            if (contadorpalabras >= 5) {
                                ...
                                Intent nuevoform = new Intent(Languages5WordsActivity.this, Game5WordsActivity.class);
                                startActivity(nuevoform); // Activamos el activity
                            }
                            else {
                                showMessageConfirmacio("Compte!", "Hi ha menys de 5 traduccions entre els dos idiomes, algunes paraules es repetiran.\nSegur que vols continuar?");
                            }
                        }
                        else {
