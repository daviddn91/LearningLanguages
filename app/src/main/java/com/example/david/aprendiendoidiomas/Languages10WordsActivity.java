...
public class Languages10WordsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.languages10words);
        Button boton = (Button) findViewById(R.id.bEnrere);
        boton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Languages10WordsActivity.this.finish(); // ... cerramos el activity actual
            }
        });
                    ...
                    if (idioma1.matches(idioma2)) {
                        ...
                        if (hiha) {
                            if (contadorpalabras >= 10) {
                                ...
                                Intent nuevoform = new Intent(Languages10WordsActivity.this, Game10WordsActivity.class);
                                startActivity(nuevoform); // Activamos el activity
                            }
                            else {
                                showMessageConfirmacio("Compte!", "Hi ha menys de 10 traduccions entre els dos idiomes, algunes paraules es repetiran.\nSegur que vols continuar?");
                            }
                        }
                        else {
