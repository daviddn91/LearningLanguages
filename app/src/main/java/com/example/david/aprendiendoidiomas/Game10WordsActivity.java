...
public class Game10WordsActivity extends ActionBarActivity {
    ...
    ArrayList<String> paraulestretes = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game10words);
                ...
                if ((e + f) >= 10) {
                    ...
                    while (c2.moveToNext()) {
                        ...
                        if ((e > paraules) || (e == paraules && t < temps)) {
                            ...
                            Cursor c3 = db.rawQuery("SELECT * FROM highscores10par WHERE id == 2", null);
                            while (c3.moveToNext()) {
                                ...
                                if ((e > paraules2) || (e == paraules2 && t < temps2)) {
                                    ...
                                    Cursor c4 = db.rawQuery("SELECT * FROM highscores10par WHERE id == 2", null);
                                    while (c4.moveToNext()) {
    ...
    public void showMessageConfirmacio(String title,String message)
    {
        ...
        builder.setNegativeButton("SI", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Game10WordsActivity.this.finish();
            }
        });
        builder.show();
    }
    ...
    public void showMessageRecords(String title,String message)
    {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Game10WordsActivity.this.finish();
                Intent nuevoform = new Intent(Game10WordsActivity.this, HighScoresActivity.class);
    ...
    public void showMessageRecordsName1(String title,String message)
    {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                db.execSQL("UPDATE highscores10par SET id = 4 WHERE id = 3");
                db.execSQL("UPDATE highscores10par SET id = 3 WHERE id = 2");
                db.execSQL("UPDATE highscores10par SET id = 2 WHERE id = 1");
                db.execSQL("UPDATE highscores10par SET id = 1 WHERE id = 4");
                db.execSQL("UPDATE highscores10par SET paraules=" + e + ", segons=" + t + ", nom = '" + nombre + "' WHERE id = 1");
                Game10WordsActivity.this.finish();
                Intent nuevoform = new Intent(Game10WordsActivity.this, HighScoresActivity.class);
                startActivity(nuevoform); // Activamos el activity
            }
    ...
    public void showMessageRecordsName2(String title,String message)
    {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                db.execSQL("UPDATE highscores10par SET id = 4 WHERE id = 3");
                db.execSQL("UPDATE highscores10par SET id = 3 WHERE id = 2");
                db.execSQL("UPDATE highscores10par SET id = 2 WHERE id = 4");
                db.execSQL("UPDATE highscores10par SET paraules=" + e + ", segons=" + t + ", nom = '" + nombre + "' WHERE id = 2");
                Game10WordsActivity.this.finish();
                Intent nuevoform = new Intent(Game10WordsActivity.this, HighScoresActivity.class);
                startActivity(nuevoform); // Activamos el activity
            }
    ...
    public void showMessageRecordsName3(String title,String message)
    {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Editable value = input.getText();
                nombre = value.toString();
                db.execSQL("UPDATE highscores10par SET paraules=" + e + ", segons=" + t + ", nom = '" + nombre + "' WHERE id = 3");
                Game10WordsActivity.this.finish();
                Intent nuevoform = new Intent(Game10WordsActivity.this, HighScoresActivity.class);
                startActivity(nuevoform); // Activamos el activity
            }
